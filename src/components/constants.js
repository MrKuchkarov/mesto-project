...
export const buttonClosePopupProfile = document.querySelector(".popup__close-icon"); 
...
export const buttonClosePopupCard = document.querySelector(".popup__close-icon_card"); 
...
export const popupFormProfile = document.querySelector('.popup__form');
export const popupFormInput = popupFormProfile.querySelector(".popup__item");
export const parentWrapper = document.querySelector("#addCardPopUpForm");
export const nameInputPopup = parentWrapper.querySelector("#popupNameTitle");
export const nameInputLink = parentWrapper.querySelector("#popupLink");
